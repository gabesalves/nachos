...
public class KThread {
	...
	public static void selfTest() {
		...
		new KThread(new PingTest(1)).setName("forked hamthread").fork();
		new PingTest(0).run();
		//Create a thread, with a nested thread inside it, to test not just join() but also
		//nested join()’s (where threads keep branching off from each other)
